...
UNITREE_MODEL_DIR = "/workspace/unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "/workspace/unitree_ros"  # Replace with the actual path to your unitree_ros package
